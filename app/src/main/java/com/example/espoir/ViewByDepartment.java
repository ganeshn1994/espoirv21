...
public class ViewByDepartment extends Activity implements Constants
{
	int flag = 0;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.view_complaints_by_dept);
		dept_name = getIntent().getExtras().getString("jsonObject");
	...
	class LoadAllProducts extends AsyncTask<String, String, String> 
	{
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ViewByDepartment.this);
		...
		protected String doInBackground(String... params) 
		{
			...
			paramValues.add(new BasicNameValuePair("dept_name", dept_name));
			// getting JSON string from URL
			JSONObject json = jParser.makeHttpRequest(url_dept, "POST", paramValues);
