...
public class ViewMyComplaints extends Activity implements Constants
{
	int flag = 0;
	...
	// url 
	private static String url_id = "http://www.shellprompt.in/Android_connect/view_my_complaints.php";
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.view_my_complaints);
		user_name = getIntent().getExtras().getString("jsonObject");
	...
	class LoadAllProducts extends AsyncTask<String, String, String>
	{
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ViewMyComplaints.this);
		...
		protected String doInBackground(String... params)
		{
			...
			paramValues.add(new BasicNameValuePair("user_id", FirstActivity.userid));
			// getting JSON string from URL
			JSONObject json = jParser.makeHttpRequest(url_id, "POST", paramValues);
